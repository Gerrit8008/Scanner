...
# FIX: Adding the missing generate_report function definition
def generate_report(lead_data, scan_results=None, for_web=True):
    """Generate a security report based on scan results
    
    Args:
        lead_data: Dictionary containing user information
        scan_results: Optional dictionary containing web scan results
        for_web: Boolean indicating if this is for web display (simplified)
